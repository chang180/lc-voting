        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="mx-4 w-full">
                ...
                <div class="text-gray-600 mt-3">
                    ...
                    adipisicing elit. Neque quis dolore, placeat facilis id cum perferendis dolores eos nam accusantium
                    dignissimos molestias reiciendis expedita delectus unde saepe tempore quas? Aut.
                </div>
                        ...
                        >
                            <button
                                ...
                                <ul
                                    x-cloak x-show="isOpen" x-transition.origin.top.left @click.away="isOpen = false"
                                    @keydown.escape.window="isOpen = false"
                                    class="absolute z-20 w-44 text-left font-semibold bg-white shadow-dialog rounded-xl py-3 ml-8">
                                    <li><a href="#"
                                            class="hover:bg-gray-100 px-5 py-3 block transition duration-150 ease-in">Mark
                                            as spam</a></li>
                                    <li><a href="#"
