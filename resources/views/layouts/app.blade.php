                ...
                <form action="#" method="post" class="space-y-4 px-4 py-6">
                    ...
                    <div>
                        <textarea name="idea" id="idea" cols="30" rows="4"
                            class="w-full bg-gray-100 text-sm rounded-xl placeholder-gray-900 border-none px-4 py-2"
        ...
        <div class="w-175">
            <nav class="flex items-center justify-between text-xs">
                <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                    ...
                    <li><a href="#"
                            class="text-gray-400 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue">Considering(6)</a>
                    </li>
                    <li><a href="#"
                ...
                <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                    ...
                    <li><a href="#"
                            class="text-gray-400 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue">Closed(6)</a>
                    </li>
                </ul>
            </nav>
