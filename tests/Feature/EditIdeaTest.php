...
class EditIdeaTest extends TestCase
{
    ...
    /** @test */
    public function does_not_show_edit_idea_livewire_component_when_user_does_not_has_authorization()
    {
        User::factory()->create();
        $user = User::find(1);
    ...
    public function editing_an_idea_works_when_user_has_authorization()
    {
        ...
        Livewire::actingAs($user)
            ...
            ->set('title', 'Idea Updated')
            ->set('category', $categoryTwo->id)
            ->set('description', 'It\'s a new description')
            ->call('updateIdea')
    ...
    /** @test */
    public function editing_an_idea_does_not_shows_on_menu_when_user_does_not_have_authorization()
    {
        User::factory()->create();
        $user = User::find(1);
    ...
    /** @test */
    public function editing_an_idea_does_not_work_when_user_does_not_have_authorization_because_idea_created_longer_than_an_hour_ago()
    {
